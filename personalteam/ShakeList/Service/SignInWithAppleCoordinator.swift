...
class SignInWithAppleCoordinater: NSObject, ASAuthorizationControllerPresentationContextProviding {
...
@available(iOS 13.0, *)
extension SignInWithAppleCoordinater: ASAuthorizationControllerDelegate {
